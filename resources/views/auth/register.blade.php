            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="banner" class="col-md-4 col-form-label text-md-end">{{ __('Bannière') }}</label>

                            <div class="col-md-6">
                                <input id="banner" type="text" class="form-control @error('banner') is-invalid @enderror" name="banner" value="{{ old('banner') }}" required autocomplete="banner" autofocus>
